...
<body class="clx-account-pages">
  <section class="clx-login-page">
    ...
    <div class="container">
      <div class="clx-account-bg" style="margin-top: 120px">
        <div class="clx-account-logo text-center alert alert-danger">
          Account Not Verified!
       </div>
      
       <div class="clx-form-box text-center" style="text-align: justify;">
         <p> An email verification link has been sent to  <b>{{ $user->email}}</b> Use the link to verify your email. If the email is incorrect, kindly re-register with the correct email</p>
         <p>Thank you.</p>
         <a  class="btn btn-clx" href="{{ route('verification.resend', encrypty($user->id))}}"> Resend Email</a>
       </div>
     </div>
   </div>
 </section>

...
<body class="clx-account-pages">
  <section class="clx-login-page">
    ...
    <div class="container">
      <div class="clx-account-bg" style="margin-top: -130px">
        <div class="clx-account-logo text-center">
         ...
         <a style="font-size: 20px; color: white; font-weight: 300;" href="/">Registration Successful!</a>
       </div>
       <h1 class="clx-account-heading text-center">
       Almost Done! </h1>
       <div class="clx-form-box text-center" style="text-align: justify;">
         <p> An email verification link has been sent to  <b>{{ $user->email}}</b> Use the link to verify your email.</p>
         <p>Thank you!</p>
         <a  class="btn btn-clx" style="color: white; text-decoration: underline; " href="{{-- {{ route('verification.resend', encrypt($user->id))}} --}}"> Resend Email</a>
         <a  class="btn btn-clx" style="color: white; text-decoration: underline; " href="/"> Goto Login</a>
       </div>
     </div>
   </div>
 </section>

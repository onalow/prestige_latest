...
<div id="main"  style="margin-top:-50px;">
    ...
    <div class="container content-top"style="padding-left: 0; padding-right: 0;">
      <div class="row" >
        ...
        <div class="col-sm-12" style="padding-left: 0; padding-right: 0;">
          ...
          <img style="max-width: 100%; height: auto;" class="img-fluid rounded d-block mx-auto" src="{{asset ("css/bundles/frontend/images/nfp.jpeg")}}">
        </div>
  ...
  <section class="section referral pt-0" style="margin-top:20px; ">
    <div class="container nfp">
      <div class="row">
        <div class="col-md-12 col-sm-12 mx-auto text-center trigger-animation">
          ...
          <div class="row">
            <div class="col-sm-6 text-center trigger-animation">
              <div class="title animated zoomIn">
                <h2>
                  <span class="d-block">HERE IS OUR STRATEGIC APPROACH IN TRADING NFP REPORT;</span>
                </h2>
                <hr>
                <p  style="text-align: justify;">
            ...
            <div class="col-sm-6  text-center trigger-animation">
              <div class="title animated zoomIn">
                <h2>
                  <span class="d-block">WHAT WE WATCHOUT FOR;</span>
            ...
            <div class="inner">
              ...
              <ul class="list-unstyled list">
                ...
                <div class="col-xs-4 mx-auto">
                  <a href="{{ route('buy.nfp')}}"> <button class="btn btn-lg btn-icon btn-danger mx-auto text-uppercase">Invest<i class="fas fa-arrow-circle-right"></i></button></a>
                </div>

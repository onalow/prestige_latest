	...
	<ul class="list-unstyled components">
		...
		<li class="">
			<a href="#pageSubmenuTrading" data-toggle="collapse" aria-expanded="false">
				...
				<span class="cld-menu-title">Crypto Investment</span>
			</a>
		...
		<li class="">
			<a href="#pageSubmenuNfp" data-toggle="collapse" aria-expanded="false">
				<i class="cl-icon cl-crpto-icon"></i>
				<span class="cld-menu-title">NFP Investment</span>
			</a>
			<ul class="collapse list-unstyled" id="pageSubmenuNfp">
				{{-- <li><a href="{{ route('buy')}}">My Current Investment</a></li> --}}
				{{-- <li><a href="plans">Top-Up Current Plan</a></li> --}}
				<li><a href="{{ route('buy.nfp')}}">Buy NFP Plan</a>
				{{-- <li><a href="{{ route('buy')}}">Upload Transaction ID</a> --}}
				</li>
			</ul>
		</li>
		...
		<li class="">
			...
			<ul class="collapse list-unstyled" id="pageSubmenuWallet">
				...
				<li><a href="{{ route('withdrawal')}}">Withdraw</a></li>
		...
		<li class="">
			<a href="#pageSubmenuBonus" data-toggle="collapse" aria-expanded="false">
				<i class="cl-icon cl-referral-icon"></i>
				<span class="cld-menu-title">Bonus</span>
			</a>
			<ul class="collapse list-unstyled" id="pageSubmenuBonus">
				<li><a href="{{ route('bonus')}}">View Bonus</a></li>
				{{-- <li><a href="/cabinet/team">My team</a></li> --}}
				{{-- <li><a href="/cabinet/bonus">Bonus</a></li> --}}
				<li><a href="#" data-toggle="modal" data-target="#upload">Upload Video</a></li>
			</ul>
		</li>		<li class="">
			...
			<ul class="collapse list-unstyled" id="pageSubmenuTeam">
				<li><a href="#ref">My Referrals / Marketing</a></li>
				{{-- <li><a href="/cabinet/team">My team</a></li> --}}
				{{-- <li><a href="/cabinet/bonus">Bonus</a></li> --}}
...
{{-- 		<li class="">
		...
		<li class="">
			<a href="#pageSubmenuSetting" data-toggle="collapse" aria-expanded="false">
				<i class="cl-icon cl-setting-icon"></i>
				<span class="cld-menu-title">Setting</span>
			</a>
			<ul class="collapse list-unstyled" id="pageSubmenuSetting">
